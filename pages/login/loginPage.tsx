  ...
  return (
    <div className=' flex h-[930px] w-[100%]'>
        ...
        <div className='h-[559px] w-[617px] flex flex-col  pt-[218px] pr-[139px] gap-14 mt-4'>
            ...
            <input type='text' placeholder='Phone number' className=' rounded-[8px] border-solid border-2  border-borderColor  h-[59px] w=[523px] placeholder-gray-500 placeholder:font-semibold px-4 '></input>
