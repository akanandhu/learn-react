    ...
    return(
        <div className='flex flex-col'>
                <div className='lg:relative md:relative md:flex flex relative   '>
                    ...
                    <div className=' lg:bg-blackGrad lg:opacity-90 lg:flex lg:align-bottom lg:items-end lg:pl-5 lg:pb-1 lg:text-white lg:font-light lg:h-[12%] lg:w-[100%] lg:absolute lg:bottom-1
                    md:bg-blackGrad md:opacity-90 md:flex md:align-bottom md:items-end md:pl-5 md:pb-1 md:text-white md:font-light md:h-[12%] md:w-[100%] md:absolute md:bottom-1
                    bg-blackGrad opacity-90 flex align-bottom items-end pl-5 pb-1 text-white font-light  h-[12%] w-[100%] absolute bottom-1'>
                 ...
                 grid grid-flow-row   bg-liveclass pl-5 pt-1 pb-5 pr-5 max-w-[2%] min-w-[530px] ' >
                    <div className='  lg:font-semibold lg:text-livetext '>
                        {subject}
                    </div>
                    ...
                    grid grid-flow-col gap-2'>
                        ...
                        md:font-bold 
                        font-bold '> <p>Beginners Guide : Biomolecules </p> </div>
                    ...
                    flex flex-1 justify-center pt-3 pb-3'>
                        ...
                        <div className='bg-black border-b-2 border-solid border-black opacity-[.3] h-[0px] w-[100%]  '>
...
function LiveClass() {
  return (
    <div>
      <div className='lg:w-[80%] lg:h-[100%] lg:bg-bodyShade lg:pl-20 lg:pt-10
