...
function Otp() {
  return (
    <div className=' pl-10 pr-10 pt-5 pb-5 bg-tableBG shadow-[0px_0px_2px_rgba(0,0,0,0.2)] lg:pl-10 lg:pr-10 lg:pt-5 lg:pb-5 lg:bg-tableBG lg:shadow-[0px_0px_2px_rgba(0,0,0,0.2)] md:pl-10 md:pr-10 md:pt-1 md-5 md:bg-tableBG md:shadow-[0px_0px_2px_rgba(0,0,0,0.2)]  '>
