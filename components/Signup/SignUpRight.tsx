...
function SignUpRight({heading} :SignUpRightProps) {
  return ( 
    <div className='pl-[53%] pt-[4%] md:pt-2 md:pr-10 md:pb-5 md:pl-3 md:mb-10   lg:pl-[38%] lg:pr-[22%] lg:pt-[9%] lg:pb-[10%] lg:mb-7 lg:flex lg:flex-1 md:mr-5  '>
        <form className=' justify-center   md:h-[100%] md:w-[100%] md:flex md:flex-col  lg:pl-20 lg:pb-28 lg:pt-[5%] lg:pr-20 md:justify-center lg:h-[90%] lg:w-[100%] lg:flex lg:flex-col lg:justify-center '>
