    ...
    <div className='pl-[15%] pt-[4%] md:mr-[5%] md:pt-[2%] md:pr-[20%] md:pb-5 md:pl-[50%] md:mb-10   lg:pl-[38%] lg:pr-[32%] lg:pt-[19%] lg:pb-[10%] lg:mb-7 lg:flex lg:flex-1 lg:mt-10  '>
        <form className=' justify-center md:mr-5 h-[100%] w-[100%]  md:h-[100%] md:w-[80%] md:flex md:flex-col lg:pt-28  lg:ml-12  lg:pl-20 lg:pb-28 lg:pr-20 md:justify-center lg:h-[90%] lg:w-[100%] lg:flex lg:flex-col lg:justify-center '>
           <div className='flex flex-col relative gap-5  '>
            ...
            <input placeholder='Phone number' type='number' className=" lg:flex   placeholder:text-extrabold  font-semibold   md:font-semibold  lg:font-semibold lg: mb-5 w-[100%] lg:w-[100%] md:w-[100%] h-[56px] border-[2px] rounded-[10px] placeholder:px-0 placeholder:text-placeText p-5 "></input>
            <input placeholder='Student name' className="font-mont-bold font-semibold md:font-mont-bold md:font-semibold lg:font-semibold  mb-5  h-[56px]  lg:w-[100%] md:w-[100%] w-[100%] border-[2px] rounded-[10px] placeholder:px-0 placeholder:text-placeText p-5"></input>
            <input placeholder='Student Email'  className="font-mont-bold font-semibold md:font-mont-bold md:font-semibold lg:font-semibold  mb-5  h-[56px] w-[100%] lg:w-[100%] md:w-[100%] border-[2px] rounded-[10px] placeholder:px-0 placeholder:text-placeText p-5"></input>
           </div>
           <div>
            ...
            <button className= ' font-mont-bold font-semibold md:font-mont-bold md:font-semibold lg:font-normal  bg-white border-slate-400 border-[3px] w-[120px] h-[43px] mr-5 rounded-[60px] text-placeText '>Plus One</button>
            <button className=' font-mont-bold font-semibold md:font-mont-bold md:font-semibold lg:font-normal  bg-white border-slate-400 border-[3px] w-[120px] h-[43px] rounded-[60px] text-placeText'>Plus Two</button> 
